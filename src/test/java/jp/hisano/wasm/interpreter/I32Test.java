...
class I32Test {
	...
	void le_u(long first, long second, long expectedValue) throws IOException {
		invoke("le_u", first, second, expectedValue);
	}
	...
	void ge_u(long first, long second, long expectedValue) throws IOException {
		invoke("ge_u", first, second, expectedValue);
	}
