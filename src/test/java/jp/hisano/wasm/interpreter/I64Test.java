...
class I64Test {
	...
	@DisplayName("i64.lt_s")
	@ParameterizedTest(name = "i64.lt_s({0}) = {1}")
	@CsvSource({
		"0,0,0",
		"1,1,0",
		"-1,1,1",
	...
	void lt_s(@WastValue long firstParameter, @WastValue long secondParameter, @WastValue int expectedResult) throws IOException {
		invokeComparator("lt_s", firstParameter, secondParameter, expectedResult);
	}

	@DisplayName("i64.lt_u")
	@ParameterizedTest(name = "i64.lt_u({0}) = {1}")
	@CsvSource({
		"0,0,0",
		"1,1,0",
		"-1,1,0",
	...
	void lt_u(@WastValue long firstParameter, @WastValue long secondParameter, @WastValue int expectedResult) throws IOException {
		invokeComparator("lt_u", firstParameter, secondParameter, expectedResult);
	}

	@DisplayName("i64.le_s")
	@ParameterizedTest(name = "i64.le_s({0}) = {1}")
	@CsvSource({
		"0,0,1",
		"1,1,1",
		"-1,1,1",
	...
	void le_s(@WastValue long firstParameter, @WastValue long secondParameter, @WastValue int expectedResult) throws IOException {
		invokeComparator("le_s", firstParameter, secondParameter, expectedResult);
	}

	@DisplayName("i64.le_u")
	@ParameterizedTest(name = "i64.le_u({0}) = {1}")
	@CsvSource({
		"0,0,1",
		"1,1,1",
		"-1,1,0",
	...
	void le_u(@WastValue long firstParameter, @WastValue long secondParameter, @WastValue int expectedResult) throws IOException {
		invokeComparator("le_u", firstParameter, secondParameter, expectedResult);
	}

	@DisplayName("i64.gt_s")
	@ParameterizedTest(name = "i64.gt_s({0}) = {1}")
	@CsvSource({
		"0,0,0",
		"1,1,0",
		"-1,1,0",
	...
	void gt_s(@WastValue long firstParameter, @WastValue long secondParameter, @WastValue int expectedResult) throws IOException {
		invokeComparator("gt_s", firstParameter, secondParameter, expectedResult);
	}

	@DisplayName("i64.gt_u")
	@ParameterizedTest(name = "i64.gt_u({0}) = {1}")
	@CsvSource({
		"0,0,0",
		"1,1,0",
		"-1,1,1",
	...
	void gt_u(@WastValue long firstParameter, @WastValue long secondParameter, @WastValue int expectedResult) throws IOException {
	...
	@DisplayName("i64.ge_u")
	@ParameterizedTest(name = "i64.ge_u({0}) = {1}")
	@CsvSource({
		"0,0,1",
		"1,1,1",
		"-1,1,1",
	...
	void ge_u(@WastValue long firstParameter, @WastValue long secondParameter, @WastValue int expectedResult) throws IOException {
		invokeComparator("ge_u", firstParameter, secondParameter, expectedResult);
	}
