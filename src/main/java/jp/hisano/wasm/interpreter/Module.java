...
public final class Module {
	...
	final static class I64Ne extends I64TwoOperandsCmpOperator {
		boolean calculate(long first, long second) {
			return first != second;
		}
	}
	...
	final static class I64GtS extends I64TwoOperandsCmpOperator {
		boolean calculate(long first, long second) {
			return first > second;
		}
	}
	...
	final static class I64GeS extends I64TwoOperandsCmpOperator {
		boolean calculate(long first, long second) {
			return first >= second;
		}
	}

	final static class I64GeU extends I64TwoOperandsCmpOperator {
		boolean calculate(long first, long second) {
			return 0 <= compareUnsigned(first, second);
		}
	}
	...
	final static class I64Extend16S extends I64Converter {
		@Override
		long convert(long value) {
			return (short)value;
		}
	...
	final static class I32TruncF32S extends PushValueInstruction {
		@Override
		Value getValue(Frame frame) {
